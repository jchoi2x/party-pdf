/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-interface Env worker-configuration.d.ts` (hash: 7a88b8fdcfd89b03352d2f035361c8cb)
...
declare namespace Cloudflare {
	...
	interface Env {
		ASSETS: Fetcher;
		UPSTREAM_ORIGIN: "https://oblockparty.xvzf.workers.dev";
	}
}
